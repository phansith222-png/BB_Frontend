  ...
  return (
    <div className="flex flex-col px-4 py-2 font-serif shadow-xl">
      ...
      <div className='mt-8 text-center flex flex-col items-center gap-5 w-full'>
        ...
        <a href="#" className="mt-2 text-md font-cormorant font-bold uppercase tracking-wide text-accent hover:text-gray-900 transition-all border-b border-gray-300 hover:border-gray-900 pb-1">
          Full Tarot Meaning
        </a>
      </div>
    </div>
